...
source .env
cast call --rpc-url $L2_RPC --private-key $DEPLOYER_PRIVATE_KEY $L2StandardBridgeProxy "withdraw(address,uint256,uint32,bytes)" "0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000" 10 1000000 0x0 --cast-async --value 10
cast call --rpc-url $L2_RPC --private-key $DEPLOYER_PRIVATE_KEY $L2StandardBridgeProxy "withdraw(address,uint256,uint32,bytes)" $L2_TOKEN_ADDRESS 10 1000000 0x0 --cast-async
